# -*- coding: utf-8 -*-
# Generated by Django 1.11 on 2017-10-30 19:43
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('net_outcome_tokens_sold', django.contrib.postgres.fields.ArrayField(base_field=models.DecimalField(decimal_places=0, max_digits=80), size=None)),
                ('marginal_prices', django.contrib.postgres.fields.ArrayField(base_field=models.DecimalField(decimal_places=4, max_digits=5), size=None)),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('past_rank', models.IntegerField(default=0)),
                ('diff_rank', models.IntegerField(default=0)),
                ('score', models.DecimalField(decimal_places=0, default=0, max_digits=80)),
                ('predicted_profit', models.DecimalField(decimal_places=0, default=0, max_digits=80)),
                ('predictions', models.IntegerField(default=0)),
                ('tokens_issued', models.BooleanField(default=False)),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('participant', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='relationaldb.TournamentParticipant')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('outcome_token_cost', models.DecimalField(decimal_places=0, max_digits=80)),
                ('fees', models.DecimalField(decimal_places=0, max_digits=80)),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('outcome_token_profit', models.DecimalField(decimal_places=0, max_digits=80)),
                ('fees', models.DecimalField(decimal_places=0, max_digits=80)),
            ],
            options={
                'abstract': False,
        ...
        migrations.AddField(
            model_name='order',
            name='outcome_token',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='relationaldb.OutcomeToken'),
        ),
        migrations.AddField(
            model_name='market',
            name='event',
