...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        """
        try:
            self.stdout.write(self.style.SUCCESS('Starting tradingdb Dump'))
            ...
            try:
                if locked:
                    ...
                    self.stdout.write(self.style.SUCCESS('tradingdb db_dump completed and saved into: {}'.format(filename)))
            ...
            self.stdout.write(self.style.ERROR('tradingdb db_dump error: {}'.format(e.message)))
